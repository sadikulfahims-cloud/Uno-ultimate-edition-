...
import { ChevronLeft, Zap, Skull, ShieldCheck } from 'lucide-react';
...
const OnlineSetupView: React.FC<OnlineSetupViewProps> = ({ onBack, onCreateLobby }) => {
  ...
  const subModeInfo = {
    ...
    NO_MERCY: {
      ...
      desc: "Stackable +2 and +4 cards. Pure chaos!"
    },
    SUPERIOR: {
      icon: <Zap className="text-yellow-400" />,
      desc: "Fast turns and secret wild cards."
    }
  };
  ...
  return (
    <div className="flex-1 flex flex-col p-6 overflow-y-auto">
      ...
      <div className="space-y-8 flex-1">
        {/* Sub-mode selection */}
        <div>
          <label className="text-xs font-bold text-white/50 uppercase ml-2 mb-4 block tracking-widest">Select Ruleset</label>
      ...
      <button
        ...
        className="w-full py-5 bg-yellow-400 text-blue-900 font-game text-xl rounded-3xl shadow-2xl hover:bg-yellow-300 transition-all transform active:scale-95 border-b-8 border-yellow-600 mt-6"
      >
        CREATE LOBBY
      </button>
    </div>
